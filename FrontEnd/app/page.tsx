		...
		<div className="min-h-screen bg-linear-to-b from-slate-50 via-white to-slate-50">
			...
			<header className="sticky top-0 z-50 backdrop-blur-sm bg-white/80 border-b border-slate-200">
				<nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
					...
					<Button className="md:hidden bg-blue-600 hover:bg-blue-700 text-white">
						Menu
					</Button>
				</nav>
			</header>
					...
					<div className="grid md:grid-cols-2 gap-12 items-center">
						<div className="space-y-8">
							<div className="space-y-4">
								<div className="inline-block bg-blue-50 px-4 py-2 rounded-full border border-blue-200">
									<span className="text-sm font-medium text-blue-700">
										💡 Novo padrão de gestão financeira
									</span>
								</div>
								<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 text-balance leading-tight">
									Sua vida financeira em{" "}
									<span className="text-blue-600">fluxo</span>
								</h1>
								<p className="text-xl text-slate-600 text-balance leading-relaxed">
									Controle seu dinheiro com inteligência. Fluxo é a plataforma
									que torna a gestão financeira simples, segura e intuitiva.
								</p>
							</div>
							...
							<p className="text-sm text-slate-500">
								✓ Sem cartão de crédito necessário • ✓ Acesso imediato • ✓ 30
								dias grátis
							</p>
						</div>
				...
				>
					<div className="text-center space-y-4 mb-12 md:mb-16">
						...
						<p className="text-lg text-slate-600 max-w-2xl mx-auto">
							Ferramentas poderosas e simples para controlar cada aspecto de
							suas finanças
						</p>
					</div>
					<div className="grid md:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								description:
									"Conecte suas contas bancárias e veja tudo em um único lugar, atualizado a cada segundo.",
							},
						].map((feature, i) => (
							<div
								key={i}
				...
				<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
					<div className="bg-linear-to-r from-blue-50 to-blue-100 rounded-2xl border border-blue-200 p-12 md:p-16 text-center space-y-8">
						<div className="space-y-4">
							...
							<p className="text-lg text-slate-600 max-w-2xl mx-auto">
								Junte-se a milhares de brasileiros que já estão economizando
								mais com Fluxo.
							</p>
						</div>
						...
						<p className="text-sm text-slate-600">
							Todos os planos incluem 30 dias grátis de acesso ilimitado
						</p>
					</div>
				</section>
