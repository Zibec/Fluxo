...
import { createRegisterFormData, RegisterFormSchema } from "@/lib/service/auth/auth-schemas"
import { zodResolver } from "@hookform/resolvers/zod"

export function RegisterForm({startTransition}: {startTransition: TransitionStartFunction}) {
    const {
        register,
        handleSubmit,
        watch,
