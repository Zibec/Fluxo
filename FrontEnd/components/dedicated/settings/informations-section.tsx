...
export function InformationsSection({ onBack }: InformationsSectionProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl rounded-3xl bg-muted p-8">
      <h2 className="mb-8 text-center text-2xl font-semibold text-foreground">Informações</h2>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="usuario123" {...field} className="bg-background" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="usuario@gmail.com" type="email" {...field} className="bg-background" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="123.456.789-00" {...field} className="bg-background" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="+55 (11) 98765-4321" {...field} className="bg-background" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
